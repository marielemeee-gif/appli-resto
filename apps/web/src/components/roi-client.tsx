...
export function RoiClient() {
  ...
  return <>
    <PageHeader eyebrow="Journal mensuel" title="Décisions prises" description={`${scenario.siteName} · distinguer ce qui était estimé de ce qui sera réellement observé.`} site={scenario.siteName} />
